...
- **Windows** 安装版、单文件版、**macOS（Apple Silicon）** DMG 与 **Linux x86_64** 安装包均已发布，tag 为 `comm-v1.8.0`。
...
| Linux（x86_64） | `CommTool_Setup_v1.8.0_linux_x86_64.run` | 免 sudo，默认 `~/.local/opt/CommTool`；glibc ≥ 2.27（Ubuntu 18.04+ / 多数麒麟） |
