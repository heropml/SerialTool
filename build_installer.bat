...
REM 从 version.py 读 __version__ 保持与 main.py 同步
set VER=1.0.0
for /f "delims=" %%v in ('py -3 -c "from version import __version__; print(__version__)" 2^>nul') do set VER=%%v

echo ============================================
echo  Building installer with Inno Setup...
echo  Version: %VER%   (from version.py)
echo ============================================
%ISCC% /DMyAppVersion=%VER% SerialTool.iss
