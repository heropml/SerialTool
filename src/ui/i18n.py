...
TR = {
    "zh": {
        ...
        "trg_webhook_insecure_tip": "仅用于你信任的局域网服务。开启后允许访问内网地址和明文 HTTP；导入外部配置时该权限会被移除。",
        "trg_run": "外部程序",
    ...
    "en": {
        ...
        "trg_webhook_insecure_tip": "Only for a trusted LAN service. This permits private addresses and clear-text HTTP; imported configs do not retain this permission.",
        "trg_run": "Run program",
    ...
    "zh_tw": {
        ...
        "trg_webhook_insecure_tip": "僅用於你信任的區域網路服務。開啟後允許內網位址和明文 HTTP；匯入外部設定時會移除此權限。",
        "trg_run": "外部程式",
