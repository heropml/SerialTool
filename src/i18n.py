...
TR = {
    "zh": {
        ...
        "ble_scan_use": "使用此设备",
        "ble_scan_hint": "双击一行，或选中后点「使用此设备」。结果按地址去重，可按名称 / 地址搜索。",
        "ble_scan_search_ph": "搜索名称或地址…",
    ...
    "en": {
        ...
        "ble_scan_hint": "Double-click a row, or select one and click Use this device. Results are deduped by address; search by name or address.",
        "ble_scan_search_ph": "Search name or address…",
    ...
    "zh_tw": {
        ...
        "ble_scan_use": "使用此裝置",
        "ble_scan_hint": "雙擊一列，或選取後點「使用此裝置」。結果按位址去重，可按名稱 / 位址搜尋。",
        "ble_scan_search_ph": "搜尋名稱或位址…",
