...
TR = {
    "zh": {
        ...
        "ar_modbus_slaves_hint": "可选：多从机 JSON 列表（填写后覆盖单地址表）。",
        "ar_modbus_slaves_bad": "多从机 JSON 无效",
        "ar_modbus_space": "空间",
    ...
    "en": {
        ...
        "ar_modbus_slaves_hint": "Optional multi-slave JSON list (overrides single addr table when set).",
        "ar_modbus_slaves_bad": "Invalid multi-slave JSON",
    ...
    "zh_tw": {
        ...
        "ar_modbus_slaves_hint": "可選：多從機 JSON 列表（填寫後覆蓋單地址表）。",
        "ar_modbus_slaves_bad": "多從機 JSON 無效",
        "ar_modbus_space": "空間",
